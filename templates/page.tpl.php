  ...
  <section class="page-row page-row-expanded">
    <div class="content<?php print (sse_theme_has_sidenav() ? ' content-has-sidenav' : ' content-no-sidenav'); ?>">
      <div class="content-container clearfix">
        <?php if (sse_theme_has_sidenav()) { print sse_theme_sidenav_output(); } ?>
